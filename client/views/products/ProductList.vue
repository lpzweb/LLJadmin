<template>
  <div>
	  ...
	  <el-table ref="singleTable" :data="tableData" highlight-current-row style="width: 100%">
	    ...
	    <el-table-column property="id" label="抓物ID"> </el-table-column>
	    <el-table-column property="type.name" label="抓物名称"> </el-table-column>
	    <el-table-column property="region" label="缩略图"> </el-table-column>
	    <el-table-column property="name" label="强抓力"> </el-table-column>
	    <el-table-column property="address" label="弱抓力"> </el-table-column>
	    <el-table-column property="contact" label="设备数量"> </el-table-column>
	    <el-table-column property="phone" label="关联 MOJIGO形象ID"> </el-table-column>
	    <el-table-column property="devicesCount" label="单位成本"> </el-table-column>
	    <el-table-column property="devicesCount" label="售价"> </el-table-column>
	    <el-table-column property="devicesCount" label="尺寸"> </el-table-column>
	    <el-table-column property="devicesCount" label="重量"> </el-table-column>
...
// import { getvalue } from '../../until/until'
  ...
  export default {
    ...
    methods: {
      ...
      addStore () {
        this.$router.push('/ProductEditor')
      },
      async loadData (page) {
        if (page) {
