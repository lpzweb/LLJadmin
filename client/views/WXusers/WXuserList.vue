<template>
  <div>
	  ...
	  <el-table ref="singleTable" :data="tableData" highlight-current-row style="width: 100%">
	    ...
	    <el-table-column property="type.name" label="用户昵称"> </el-table-column>
	    <el-table-column property="region" label="用户头像"> </el-table-column>
	    <el-table-column property="name" label="当前称号"> </el-table-column>
	    <el-table-column property="address" label="注册时间"> </el-table-column>
	    <el-table-column property="contact" label="累计充值金额/元"> </el-table-column>
	    <el-table-column property="phone" label="账户余额/啵啵币"> </el-table-column>
	    <el-table-column property="devicesCount" label="其他方式获得啵啵币"> </el-table-column>
	    <el-table-column property="devicesCount" label="总抓取/次"> </el-table-column>
	    <el-table-column property="devicesCount" label="总抓中/次"> </el-table-column>
